...
import { pluginChainResolver } from "https://deno.land/x/denopack@0.8.0/plugin/chainResolver/mod.ts";
import { pluginCacheResolver } from "https://deno.land/x/denopack@0.8.0/plugin/cacheResolver/mod.ts";
