...
export interface PluginContext extends MinimalPluginContext {
  ...
  resolve: (source: string, importer?: string, options?: { skipSelf: boolean }) => Promise<ResolvedId | null>;
  /** @deprecated Use `this.resolve` instead */
...
) => Promise<{ code: string; map?: SourceMapInput } | null> | { code: string; map?: SourceMapInput } | string | null;
...
interface OutputPluginHooks {
  ...
  writeBundle: (this: PluginContext, options: NormalizedOutputOptions, bundle: OutputBundle) => void | Promise<void>;
}
