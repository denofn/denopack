    ...
    <Page active="home">
      <>
        ...
        >
          ...
          <p className={heroP}>
            <img
              src="https://img.shields.io/github/v/tag/denofn/denopack?label=latest&labelColor=black&style=flat&color=teal"
            />
            {" "}
            <a href="https://deno.land/x/denopack">
              <img
                src="https://img.shields.io/badge/Available%20on-deno.land/x-teal.svg?style=flat&logo=deno&labelColor=black"
              />
            </a>
            {" "}
        ...
        <SidebarContainer active="home">
          ...
          <Section title="Goal" className={sectionContainer}>
            <p>
              ...
              as minifying, tree shaking, ...
            </p>
            <p>
              denopack's goal is to provide a pluggable bundling solution for
              the Deno ecosystem, using Rollup behind the scenes, continually
              expanding functionality. It is important for both backend and
              frontend development on Deno to be able to use a mature and
